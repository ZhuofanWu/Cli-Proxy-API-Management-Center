            ...
            <SectionStack>
              ...
              {values.usageStatisticsEnabled ? (
                <SectionGrid>
                  <FieldShell
                    label={t(
                      'config_management.visual.sections.system.usage_statistics_storage_way'
                    )}
                    labelId={usageStatisticsStorageWayLabelId}
                    htmlFor={`${usageStatisticsStorageWayLabelId}-select`}
                    hint={t(
                      'config_management.visual.sections.system.usage_statistics_storage_way_hint'
                    )}
                    hintId={usageStatisticsStorageWayHintId}
                  >
                    <Select
