...
const extractSectionValue = (config: Config | null, section?: RawConfigSection) => {
  ...
  switch (section) {
    ...
    case 'usage-statistics-storage-way':
      return config.usageStatisticsStorageWay;
    case 'request-log':
    ...
    set((state) => {
      ...
      switch (section) {
        ...
        case 'usage-statistics-enabled':
          ...
          break;
        case 'usage-statistics-storage-way':
          nextConfig.usageStatisticsStorageWay = value as Config['usageStatisticsStorageWay'];
          break;
        case 'request-log':
